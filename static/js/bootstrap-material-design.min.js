(function (e, t) {
  typeof exports === 'object' && typeof module !== 'undefined' ? t(require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define(['jquery', 'popper.js'], t) : t(e.jQuery, e.Popper)
})(this, function (e, t) {
  'use strict';
  ...
  var l = (function (e) {
      ...
      function o () {
        return typeof window !== 'undefined' && window.QUnit ? !1 : {
          end: 'transitionend'
        }
      }
        ...
        d = (function () {
          ...
          return a.close = function (e) {
            ...
            return this.each(function () {
              var a = e(this),
                r = a.data(n);
              r || (r = new t(this), a.data(n, r)), o === 'close' && r[o](this)
            })
      ...
      var t = 'button',
        ...
        c = (function () {
          ...
          return a.toggle = function () {
            ...
            return this.each(function () {
              var a = e(this).data(n);
              a || (a = new t(this), e(this).data(n, a)), o === 'toggle' && a[o]()
            })
          }, o(t, null, [{
            key: 'VERSION',
            get: function () {
        ...
        g = (function () {
          ...
          return i.next = function () {
            ...
            this._config.keyboard && e(this._element).on(_.KEYDOWN, function (e) {
              return t._keydown(e)
            }), this._config.pause === 'hover' && (e(this._element).on(_.MOUSEENTER, function (e) {
              return t.pause(e)
            ...
            if ((o && a === 0 || n && a === r) && !this._config.wrap) return t;
            var i = e === c.PREV ? -1 : 1,
            ...
            return this.each(function () {
              ...
              typeof t === 'object' && e.extend(a, t);
              var i = typeof t === 'string' ? t : a.slide;
              if (o || (o = new r(this, a), e(this).data(n, o)), typeof t === 'number') o.to(t);
        ...
        f = (function () {
          function r (t, n) {
            ...
            for (var o = e(g.DATA_TOGGLE), a = 0; a < o.length; a++) {
              ...
              i !== null && e(i).filter(t).length > 0 && (this._selector = i, this._triggerArray.push(r))
            }
          ...
          return i.toggle = function () {
            ...
            if (!(this._isTransitioning || e(this._element).hasClass(p.SHOW))) {
              var o, a;
              if (this._parent && (o = e.makeArray(e(this._parent).find(g.ACTIVES).filter('[data-parent="' + this._config.parent + '"]')), o.length === 0 && (o = null)), !(o && (a = e(o).not(this._selector).data(n), a && a._isTransitioning))) {
                var i = e.Event(_.SHOW);
                if (e(this._element).trigger(i), !i.isDefaultPrevented()) {
                  o && (r._jQueryInterface.call(e(o).not(this._selector), 'hide'), !a && e(o).data(n, null));
                  var d = this._getDimension();
                  e(this._element).removeClass(p.COLLAPSE).addClass(p.COLLAPSING), this._element.style[d] = 0, this._triggerArray.length > 0 && e(this._triggerArray).removeClass(p.COLLAPSED).attr('aria-expanded', !0), this.setTransitioning(!0);
                  var c = function () {
            ...
            if (!this._isTransitioning && e(this._element).hasClass(p.SHOW)) {
              ...
              if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
                ...
                if (this._element.style[o] = this._element.getBoundingClientRect()[o] + 'px', l.reflow(this._element), e(this._element).addClass(p.COLLAPSING).removeClass(p.COLLAPSE).removeClass(p.SHOW), this._triggerArray.length > 0) {
            ...
            var t = this,
              n = null;
            l.isElement(this._config.parent) ? (n = this._config.parent, typeof this._config.parent.jquery !== 'undefined' && (n = this._config.parent[0])) : n = e(this._config.parent)[0];
            ...
            if (t) {
              ...
              n.length > 0 && e(n).toggleClass(p.COLLAPSED, !o).attr('aria-expanded', o)
            }
            ...
            return this.each(function () {
              var o = e(this),
                i = o.data(n),
                l = a({}, d, o.data(), typeof t === 'object' && t);
              if (!i && l.toggle && /show|hide/.test(t) && (l.toggle = !1), i || (i = new r(this, l), o.data(n, i)), typeof t === 'string') {
                if (typeof i[t] === 'undefined') throw new TypeError('No method named "' + t + '"');
                i[t]()
              }
            })
          }, o(r, null, [{
        ...
        f = (function () {
          ...
          return f.toggle = function (e) {
            ...
            e(document).off(p.FOCUSIN).on(p.FOCUSIN, function (n) {
              document !== n.target && t._element !== n.target && e(t._element).has(n.target).length === 0 && t._element.focus()
            })
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              if (this._backdrop = document.createElement('div'), this._backdrop.className = m.BACKDROP, o && e(this._backdrop).addClass(o), e(this._backdrop).appendTo(document.body), e(this._element).on(p.CLICK_DISMISS, function (e) {
                return n._ignoreBackdropClick ? void (n._ignoreBackdropClick = !1) : void (e.target !== e.currentTarget || (n._config.backdrop === 'static' ? n._element.focus() : n.hide()))
            ...
            e(g.FIXED_CONTENT).each(function (t, n) {
              ...
              typeof o !== 'undefined' && e(n).css('padding-right', o).removeData('padding-right')
            }), e(g.STICKY_CONTENT + ', ' + g.NAVBAR_TOGGLER).each(function (t, n) {
              var o = e(n).data('margin-right');
              typeof o !== 'undefined' && e(n).css('margin-right', o).removeData('margin-right')
            });
            ...
            return this.each(function () {
              var r = e(this).data(n),
                l = a({}, i.Default, e(this).data(), typeof t === 'object' && t);
              if (r || (r = new i(this, l), e(this).data(n, r)), typeof t === 'string') {
    ...
    m = (function (e) {
      var n = 'tooltip',
        ...
        h = (function () {
          function s (e, n) {
            if (typeof t === 'undefined') throw new TypeError('Bootstrap tooltips require Popper.js (https://popper.js.org)');
          ...
          return h.enable = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              var d = typeof this.config.placement === 'function' ? this.config.placement.call(this, r, this.element) : this.config.placement,
            ...
            var n = this,
              ...
              r = function () {
                n._hoverState !== m.SHOW && o.parentNode && o.parentNode.removeChild(o), n._cleanTipClass(), n.element.removeAttribute('aria-describedby'), e(n.element).trigger(n.constructor.Event.HIDDEN), n._popper !== null && n._popper.destroy(), t && t()
              };
            ...
            typeof n === 'object' && (n.nodeType || n.jquery) ? o ? !e(n).parent().is(t) && t.empty().append(n) : t.text(e(n).text()) : t[o ? 'html' : 'text'](n)
          }, h.getTitle = function () {
            ...
            return (n = n || e(t.currentTarget).data(o), n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()), e(t.currentTarget).data(o, n)), t && (n._activeTrigger[t.type === 'focusin' ? E.FOCUS : E.HOVER] = !0), e(n.getTipElement()).hasClass(f.SHOW) || n._hoverState === m.SHOW) ? void (n._hoverState = m.SHOW) : (clearTimeout(n._timeout), n._hoverState = m.SHOW, n.config.delay && n.config.delay.show ? void (n._timeout = setTimeout(function () {
              n._hoverState === m.SHOW && n.show()
            }, n.config.delay.show)) : void n.show())
          }, h._leave = function (t, n) {
            var o = this.constructor.DATA_KEY;
            if (n = n || e(t.currentTarget).data(o), n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()), e(t.currentTarget).data(o, n)), t && (n._activeTrigger[t.type === 'focusout' ? E.FOCUS : E.HOVER] = !1), !n._isWithActiveTrigger()) {
            ...
            return t = a({}, this.constructor.Default, e(this.element).data(), t), typeof t.delay === 'number' && (t.delay = {
              show: t.delay,
              hide: t.delay
            }), typeof t.title === 'number' && (t.title = t.title.toString()), typeof t.content === 'number' && (t.content = t.content.toString()), l.typeCheckConfig(n, t, this.constructor.DefaultType), t
            ...
            t.getAttribute('x-placement') !== null || (e(t).removeClass(f.FADE), this.config.animation = !1, this.hide(), this.show(), this.config.animation = n)
          }, s._jQueryInterface = function (t) {
            return this.each(function () {
              var n = e(this).data(r);
              if ((n || !/dispose|hide/.test(t)) && (n || (n = new s(this, typeof t === 'object' && t), e(this).data(r, n)), typeof t === 'string')) {
      ...
      var t = 'popover',
        ...
        f = (function (a) {
          ...
          return m.isWithContent = function () {
            ...
            typeof n === 'function' && (n = n.call(this.element)), this.setElementContent(t.find(p.CONTENT), n), t.removeClass(_.FADE + ' ' + _.SHOW)
            ...
            return this.each(function () {
              var o = e(this).data(n),
                a = typeof t === 'object' ? t : null;
              if ((o || !/destroy|hide/.test(t)) && (o || (o = new l(this, a), e(this).data(n, o)), typeof t === 'string')) {
                if (typeof o[t] === 'undefined') throw new TypeError('No method named "' + t + '"');
                o[t]()
              }
            })
          }, o(l, null, [{
    ...
    f = (function (e) {
      var t = 'scrollspy',
        ...
        f = (function () {
          function s (t, n) {
            var o = this;
            this._element = t, this._scrollElement = t.tagName === 'BODY' ? window : t, this._config = this._getConfig(n), this._selector = this._config.target + ' ' + m.NAV_LINKS + ',' + (this._config.target + ' ' + m.LIST_ITEMS + ',') + (this._config.target + ' ' + m.DROPDOWN_ITEMS), this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on(_.SCROLL, function (e) {
              return o._process(e)
          ...
          return f.refresh = function () {
            var t = this,
              ...
              o = this._config.method === 'auto' ? n : this._config.method,
            ...
            if (n = a({}, d, n), typeof n.target !== 'string') {
            ...
            for (var a, r = this._offsets.length; r--;) a = this._activeTarget !== this._targets[r] && e >= this._offsets[r] && (typeof this._offsets[r + 1] === 'undefined' || e < this._offsets[r + 1]), a && this._activate(this._targets[r])
            ...
            return this.each(function () {
              var o = e(this).data(n);
              if (o || (o = new s(this, typeof t === 'object' && t), e(this).data(n, o)), typeof t === 'string') {
                if (typeof o[t] === 'undefined') throw new TypeError('No method named "' + t + '"');
                o[t]()
              }
            })
        ...
        c = (function () {
          ...
          return a.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(s.ACTIVE) || e(this._element).hasClass(s.DISABLED))) {
              ...
              if (a) {
                var c = a.nodeName === 'UL' ? d.ACTIVE_UL : d.ACTIVE;
            ...
            var a, r = this;
            a = n.nodeName === 'UL' ? e(n).find(d.ACTIVE_UL) : e(n).children(d.ACTIVE);
            var i = a[0],
            ...
            if (n) {
              ...
              a && e(a).removeClass(s.ACTIVE), n.getAttribute('role') === 'tab' && n.setAttribute('aria-selected', !1)
            }
            if (e(t).addClass(s.ACTIVE), t.getAttribute('role') === 'tab' && t.setAttribute('aria-selected', !0), l.reflow(t), e(t).addClass(s.SHOW), t.parentNode && e(t.parentNode).hasClass(s.DROPDOWN_MENU)) {
            ...
            return this.each(function () {
              var a = e(this),
                r = a.data(n);
              if (r || (r = new t(this), a.data(n, r)), typeof o === 'string') {
                if (typeof r[o] === 'undefined') throw new TypeError('No method named "' + o + '"');
                r[o]()
              }
            })
          }, o(t, null, [{
      ...
      var t = {
        ...
        a = (function () {
          ...
          return r.dispose = function (e) {
            ...
            return o.length === 0 && t && e.error('Failed to find ' + n.BMD_FORM_GROUP + ' for ' + E.describe(this.$element)), o
          }, a
        }());
      return a
    }(jQuery)),
        ...
        i = (function (i) {
          ...
          return s.dispose = function (e) {
            ...
            for (var o = null, a = this.config.label.selectors, r = Array.isArray(a), i = 0, a = r ? a : a[Symbol.iterator](); ;) {
              ...
              var s = l;
              if (o = e.isFunction(s) ? s(this) : this.$bmdFormGroup.find(s), void 0 !== o && o.length > 0) break
            }
            return o.length === 0 && t && e.error('Failed to find ' + n.BMD_LABEL_WILDCARD + ' within form-group for ' + E.describe(this.$element)), o
          }, s.findFormGroup = function (t) {
            void 0 === t && (t = !0);
            var o = this.$element.closest(n.FORM_GROUP);
            return o.length === 0 && t && e.error('Failed to find ' + n.FORM_GROUP + ' for ' + E.describe(this.$element)), o
      ...
      var t = {
        ...
        o = (function (o) {
          ...
          return i.decorateMarkup = function () {
            ...
            E.assert(this.$element, !this.$element.parent().prop('tagName') === 'label', this.constructor.name + '\'s ' + E.describe(this.$element) + ' parent element should be <label>.'), E.assert(this.$element, !this.outerElement().hasClass(this.outerClass), this.constructor.name + '\'s ' + E.describe(this.$element) + ' outer element should have class ' + this.outerClass + '.')
      ...
      var t = 'collapseInline',
        ...
        d = (function (t) {
          function o (n, o) {
            ...
            var r = n.data('target');
            a.$collapse = e(r), E.assert(n, a.$collapse.length === 0, 'Cannot find collapse target for ' + E.describe(n)), E.assert(a.$collapse, !a.$collapse.hasClass(l.COLLAPSE), E.describe(a.$collapse) + ' is expected to have the \'' + l.COLLAPSE + '\' class.  It is being targeted by ' + E.describe(n));
            var d = a.$bmdFormGroup.find(i.ANY_INPUT);
            return d.length > 0 && (a.$input = d.first()), a.$collapse.hasClass(l.WIDTH) || a.$collapse.addClass(l.WIDTH), a.$input && (a.$collapse.on('shown.bs.collapse', function () {
              a.$input.focus()
      ...
      var t = 'file',
        ...
        d = (function (t) {
          ...
          return a.dispose = function () {
            ...
            E.assert(this.$element, !this.outerElement().prop('tagName') === 'label', this.constructor.name + '\'s ' + E.describe(this.$element) + ' parent element ' + E.describe(this.outerElement()) + ' should be <label>.'), E.assert(this.$element, !this.outerElement().hasClass(l.FILE), this.constructor.name + '\'s ' + E.describe(this.$element) + ' parent element ' + E.describe(this.outerElement()) + ' should have class .' + l.FILE + '.')
      ...
      var t = 'dropdown',
        ...
        h = (function () {
          ...
          return i.toggle = function () {
            ...
            e.removeData(this._element, n), e(this._element).off(a), this._element = null, this._menu = null, this._popper !== null && this._popper.destroy(), this._popper = null
          }, i.update = function () {
            ...
            return this.each(function () {
              var o = e(this).data(n),
                a = typeof t === 'object' ? t : null;
              if (o || (o = new r(this, a), e(this).data(n, o)), typeof t === 'string') {
                if (void 0 === o[t]) throw new Error('No method named "' + t + '"');
                o[t]()
              }
            })
          }, r._clearMenus = function (t) {
            if (!(t && (t.which === 3 || t.type === 'keyup' && t.which !== c))) {
              for (var o, a = e.makeArray(e(g.DATA_TOGGLE)), l = function (o) {
                  ...
                  if (t && (t.type === 'click' && /input|textarea/i.test(t.target.tagName) || t.type === 'keyup' && t.which === c) && e.contains(i, t.target)) return 'continue';
                ...
                }, s = 0; s < a.length; s++) o = l(s), o === 'continue'
            }
            ...
            if (!(!_.test(t.which) || /button/i.test(t.target.tagName) && t.which === d || /input|textarea/i.test(t.target.tagName)) && (t.preventDefault(), t.stopPropagation(), !(this.disabled || e(this).hasClass(m.DISABLED)))) {
              ...
              if (i.length) {
                ...
                t.which === 38 && l > 0 && l--, t.which === 40 && l < i.length - 1 && l++, l < 0 && (l = 0), i[l].focus()
              }
            }
          }, o(r, null, [{
            key: 'VERSION',
      ...
      var t = {
        ...
        a = (function (t) {
          ...
          return i.dispose = function (e) {
            ...
            return a.length === 0 && t && e.error('Failed to find ' + n.CANVAS + ' for ' + E.describe(o)), a
            ...
            return a.length === 0 && t && e.error('Failed to find ' + n.BACKDROP + ' for ' + E.describe(o)), a
          }, i.findContainer = function (t, o) {
            void 0 === t && (t = !0), void 0 === o && (o = this.$element);
            var a = o.closest(n.CONTAINER);
            return a.length === 0 && t && e.error('Failed to find ' + n.CONTAINER + ' for ' + E.describe(o)), a
          }, a
        }(h));
      return a
    }(jQuery)),
        ...
        d = (function (t) {
          ...
          return a.dispose = function () {
            ...
            if (!(this._isForcedClosed() || this._isOpen())) {
              ...
              e.length > 0 && e.first().focus(), this.$container.addClass(l.DRAWER_IN), this.$backdrop.addClass(l.IN)
            }
          }, a.hide = function () {
      ...
      var t = 'ripples',
        ...
        d = (function () {
          ...
          return o.dispose = function () {
            ...
            (!this.$container || !this.$container.length > 0) && (this.$element.append(this.config.container.template), this.$container = this.$element.find(l.CONTAINER)), this.$container.append(this.config.decorator.template), this.$decorator = this.$container.find(l.DECORATOR)
